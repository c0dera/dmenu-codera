...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeNormHighlight, SchemeSelHighlight, SchemeMid,
...
keypress(XKeyEvent *ev)
{
	...
	if (ev->state & ControlMask) {
		...
		case XK_i: ksym = XK_f;       break;
		case XK_j: /* fallthrough */
		case XK_J: /* fallthrough */
		case XK_m: /* fallthrough */
		case XK_M: ksym = XK_Return; ev->state &= ~ControlMask; break;
		case XK_n: ksym = XK_Right;      break;
		case XK_p: ksym = XK_Left;        break;
...
usage(void)
{
	fputs("usage: dmenu [-bfinrPhv] [-l lines] [-p prompt] [-fn font] [-m monitor] [-h line height]\n"
	      "             [-nb color] [-nf color] [-r] [-sb color] [-sf color] [-H histfile]\n"
